...
import { writeDailyAnalysisHistorySnapshots } from "@/lib/firebase/firestore-analysis-history-service";
...
async function handleRun(request: NextRequest, trigger: "cron" | "manual") {
  ...
  try {
    ...
    const result = await writeDailyAnalysisHistorySnapshots({ dryRun });
